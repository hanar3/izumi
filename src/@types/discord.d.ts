declare module "discord.js" {
  ...
  export type CollectorOptionsTypeResolver<
    U extends InteractionCollectorOptionsResolvable<Cached>,
    Cached = boolean
  > = {
  ...
  export type MappedInteractionCollectorOptions<Cached = boolean> =
    CollectorOptionsTypeResolver<
  ...
  > = T extends MessageComponentType | MessageComponentTypes
    ? MappedInteractionCollectorOptions<C>[T] extends InteractionCollectorOptions<
        infer Item
      >
      ? Item
      : never
  ...
  export type GuildTextBasedChannel = Exclude<
    TextBasedChannels,
  ...
  export class Message<Cached extends boolean = boolean> extends Base {
    ...
    ): Promise<InteractionExtractor<T, Cached>>;
  ...
  export class MessageActionRow extends BaseMessageComponent {
    public constructor(
      data?: MessageActionRow | MessageActionRowOptions | APIActionRowComponent
    );
  ...
  export type GuildTextChannelResolvable =
    | TextChannel
    | NewsChannel
    | Snowflake;
  ...
  export interface ImageURLOptions
    extends Omit<StaticImageURLOptions, "format"> {
    dynamic?: boolean;
    format?: DynamicImageFormat;
  }
  ...
  export interface ButtonInteractionCollectorOptions<Cached = boolean>
    extends MessageComponentCollectorOptions<
      Cached extends true ? ButtonInteraction<"cached"> : ButtonInteraction
    > {
